 ...
 */
    ...
    hasRowConflictAt: function(rowIndex) {
      ...
      for(var i = 0; i < this.n(); i++){
        count += this.getPiece(rowIndex, i);
      }
    ...
    hasColConflictAt: function(colIndex) {
      ...
      for(var i = 0; i < this.n(); i++){
        count += this.getPiece(i, colIndex);
      }
    ...
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      var counter = 0;
      for(var i = 0; i< this.n(); i++){
        counter += this.getPiece(i, majorDiagonalColumnIndexAtFirstRow +i);
      }
      return (counter > 1);
    },
    ...
    hasAnyMajorDiagonalConflicts: function() {
      var n = this.n();//- (2 * this.n() + 1);

      for(var i = (0-(n-1)+1); i <= ((n-1)-1); i++){
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      ...
      for(var i = 0; i < this.n(); i++){
        counter += this.getPiece(0 + i, minorDiagonalColumnIndexAtFirstRow - i);
      }
    ...
    hasAnyMinorDiagonalConflicts: function() {
      var n = this.n();// + (this.n() - 1);

      for(var i = 1; i <= ((n-1)+(n-1)-1); i++){
